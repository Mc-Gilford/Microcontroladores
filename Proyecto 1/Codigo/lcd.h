...
#define LCD_D5       PORTCbits.RC2
#define LCD_D6       PORTCbits.RC1
#define LCD_D7       PORTCbits.RC0
#define LCD_RS_DIR   TRISCbits.TRISC5
#define LCD_EN_DIR   TRISCbits.TRISC4
#define LCD_D4_DIR   TRISCbits.TRISC3
#define LCD_D5_DIR   TRISCbits.TRISC2
#define LCD_D6_DIR   TRISCbits.TRISC1
#define LCD_D7_DIR   TRISCbits.TRISC0
